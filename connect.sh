...
k8s_connect_gke() {
    ...
    export K8S_ENVIRONMENT_LABEL
    export K8S_DEFAULT_ENVIRONMENT_LABEL
    export K8S_OVERRIDE_HELM_RELEASE_NAME
  ...
  if [ "${K8S_CONNECT_NO_PS_CHANGE}" != "yes" ]; then
